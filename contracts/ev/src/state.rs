use crate::msg::{EnergyTransfer, EnergyTransferOffer, OldEnergyTransferOffer};
use cw_storage_plus::{Map, Item};

pub const ENERGY_TRANSFER_OFFERS: Map<u64, EnergyTransferOffer> = Map::new("energy_transfer_offers");
pub const OLD_ENERGY_TRANSFER_OFFERS: Map<u64, OldEnergyTransferOffer> = Map::new("energy_transfer_offers");
